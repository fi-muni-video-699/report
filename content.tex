...
given \term{frame} of the video files, which can be immediately used to
\begin{enumerate}
...
interval (\abbr{CI}) by taking the sample quantiles of the observed ranks. For
...
\iffalse
Model selection, task 1a
- CIs are wide to the point of being useless,
- according the the expected value, all models are better than random,
- $\theta_1$ (flipping) and $\theta_3$ (relative luminance histogram weights) underperform
- despite a lack of parameters, \abbr{VGG} yields high results
- none of the models is provably better than random

Model selection, task 1b
- due to the normal approximation, CIs are much more narrow
- at least one of the models is provably better than random
- none of the models is provably better than conservative
\fi
