...
\begin{description}
  \begin{figure}
    \showexample{fig/examples/normal}%
  ...
  \begin{figure}
    \showexample{fig/examples/incremental-only}%
    ...
    \kern\floatsep
    \showexample{fig/examples/no-keyrefs}%
    ...
    \label{fig:example-normal}
  \end{figure}
  \item[Only incremental matches] In 153 out of the total 683 screen elements,
    the projection screen shows none of the lecture slide pages; it only shows
  ...
  \begin{figure}
    \showexample{fig/examples/windowed}%
    ...
    \kern\floatsep
    \showexample{fig/examples/obstacle}%
