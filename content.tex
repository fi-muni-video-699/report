...
top-ranking one. To compare two systems, we may estimate the expected value and
the variance of the \term{rank} of a matching page produced by the two systems
across one or several test dataset.
...
log-likelihood~\cite[sec~2.6.3]{friedman2001elements}).
